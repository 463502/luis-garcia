...
public class MainEncuentro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jblEquipo0 = new javax.swing.JLabel();
        ...
        jblEquipo.setBackground(new java.awt.Color(0, 51, 102));
        jblEquipo.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jblEquipo.setForeground(new java.awt.Color(255, 255, 255));
        jblEquipo.setText("VISITANTE");

        jblEquipo0.setBackground(new java.awt.Color(0, 51, 102));
        jblEquipo0.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jblEquipo0.setForeground(new java.awt.Color(255, 255, 255));
        jblEquipo0.setText("LOCAL");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(156, 166, Short.MAX_VALUE))
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addComponent(btnPausar1, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void btnIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarActionPerformed
        ...
        for (int i = 0; i < Control.getEquipos().size(); i++) {
            int o = 0;
            o++;
            jlbEquipo1.setText(Control.getEquipos().get(i).getNombre());
    ...
    private javax.swing.JLabel jblEquipo0;
